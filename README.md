[![Circle CI](https://circleci.com/gh/ionic-team/ionic-native.svg?style=shield)](https://circleci.com/gh/ionic-team/ionic-native) [![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/) ![](https://img.shields.io/npm/v/ionic-msal-native/core.svg)
...
```bash
npm install ionic-msal-native/core --save
```
...
```typescript
// app.module.ts
import { Camera } from 'ionic-msal-native/camera/ngx';
...
```typescript
import { Geolocation } from 'ionic-msal-native/geolocation/ngx';
...
npm install ionic-msal-native/core

# Install Ionic Native TypeScript wrapper
npm install ionic-msal-native/barcode-scanner
...
```typescript
import { BarcodeScanner } from 'ionic-msal-native/barcode-scanner';
...
```js
import { Camera } from 'ionic-msal-native/camera';
