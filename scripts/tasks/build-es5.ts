...
const webpackConfig: webpack.Configuration = {
  ...
  resolve: {
    ...
    extensions: ['.js'],
    alias: {
      'ionic-msal-native/core': path.resolve(DIST, 'ionic-msal-native/core/index.js'),
    },
  },
  module: {
    rules: [
...
function createIndexFile() {
  ...
  fileContent += '\n};\n';
  fileContent += `require('./ionic-msal-native/core/bootstrap').checkReady();\n`;
  fileContent += `require('./ionic-msal-native/core/ng1').initAngular1(window.IonicNative);`;
