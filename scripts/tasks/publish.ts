...
const DIST = path.resolve(ROOT, 'dist/ionic-msal-native');
...
const PLUGIN_PEER_DEPENDENCIES = {
  'ionic-msal-native/core': MIN_CORE_VERSION,
  rxjs: RXJS_VERSION,
};

function getPackageJsonContent(name: string, peerDependencies = {}, dependencies = {}) {
  return merge(PACKAGE_JSON_BASE, {
    name: 'ionic-msal-native/' + name,
    dependencies,
    peerDependencies,
    version: VERSION,
  });
...
function prepare() {
  // write ionic-msal-native/core package.json
  writePackageJson(
